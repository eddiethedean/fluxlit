...
cleanup() {
  docker compose -f docker-compose.yml -f docker-compose.traefik.yml down -v 2>/dev/null || true
...
echo "=== Traefik strip-prefix (8085) ==="
docker compose -f docker-compose.yml -f docker-compose.traefik.yml up -d --build
BASE_URL=http://127.0.0.1:8085 ./smoke-test.sh
